...
namespace DBFirstApp.Controllers
{
    ...
    {
        private readonly WebProgrammingContext _context;

        public LearnersController(WebProgrammingContext context)
        {
            _context = context;
        }
        ...
        {
            var webProgrammingContext = _context.Learners.Include(l => l.Major);
            return View(await webProgrammingContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'WebProgrammingContext.Learners'  is null.");
            }
            var learner = await _context.Learners.FindAsync(id);
            if (learner != null)
            {
